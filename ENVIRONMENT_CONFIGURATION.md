...
DEBUG=False
DATABASE_URL=postgresql://user:password@localhost:5432/librepos
```
...
|----------|-------------|---------|
| `DATABASE_URL` | SQLAlchemy connection URI | `sqlite:///librepos.db` |

See [Database Configuration](DATABASE_CONFIGURATION.md) for connection string formats.
...
# PostgreSQL database
DATABASE_URL=postgresql://librepos:strongpassword@localhost:5432/librepos
