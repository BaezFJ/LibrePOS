...
class UserProfileForm(FlaskForm):
    first_name = StringField('First Name', validators=[DataRequired()], render_kw=field_kwargs)
    middle_name = StringField('Middle Name', render_kw=field_kwargs)
    last_name = StringField('Last Name', validators=[DataRequired()], render_kw=field_kwargs)
