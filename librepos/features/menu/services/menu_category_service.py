...
class MenuCategoryService(BaseService):
    ...
    def create_category(self, data):
        ...
        return self._execute_with_error_handling(_create_operation, "Error creating category")
    ...
    def update_category(self, category_id: int, data):
        ...
        return self._execute_with_error_handling(_update_operation, "Error updating category")
    ...
    def delete_category(self, category_id):
        ...
        return self._execute_with_error_handling(_delete_operation, "Error deleting category")
